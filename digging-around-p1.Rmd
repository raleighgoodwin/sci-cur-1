...
* Outliers:
  ...
  + Poor Performance on Filler Items (***)
...
amodel1 <- lm(data = dfc2, formula = arctic20 ~ con + rav_scored)
summary(amodel1)

amodel2 <- lm(data = dfc2, formula = arctic20 ~ sc_scored + con + rav_scored)
summary(amodel2)

tmodel1 <- lm(data = dfc2, formula = temp20 ~ con + rav_scored)
summary(tmodel1)

tmodel2 <- lm(data = dfc2, formula = temp20 ~ sc_scored + con + rav_scored)
summary(tmodel2)

omodel1 <- lm(data = dfc2, formula = ozone20 ~ con + rav_scored)
summary(omodel1)

omodel2 <- lm(data = dfc2, formula = ozone20 ~ sc_scored + con + rav_scored)
summary(omodel2)

aqmodel1 <- lm(data = dfc2, formula = airqual20 ~ con + rav_scored)
summary(aqmodel1)

aqmodel2 <- lm(data = dfc2, formula = airqual20 ~ sc_scored + con + rav_scored)
summary(aqmodel2)
```
...
```{r arc-log-model}
arcticmodel1 <- glm(data = dfc2, formula = ebiasiz15_arctic ~ con + rav_scored, family = "binomial")
summary(arcticmodel1)

arcticmodel2 <- glm(data = dfc2, formula = ebiasiz15_arctic ~ sc_scored + con + rav_scored, family = "binomial")
summary(arcticmodel2)
```

```{r temp-log-model}
tempmodel1 <- glm(data = dfc2, formula = ebiasiz15_temp ~ con + rav_scored, family = "binomial")
summary(tempmodel1)

tempmodel2 <- glm(data = dfc2, formula = ebiasiz15_temp ~ sc_scored + con + rav_scored, family = "binomial")
summary(tempmodel2)
```

```{r ozone-log-model}
ozonemodel1 <- glm(data = dfc2, formula = ebiasiz15_ozone ~ con + rav_scored, family = "binomial")
summary(ozonemodel1)

ozonemodel2 <- glm(data = dfc2, formula = ebiasiz15_ozone ~ sc_scored + con + rav_scored, family = "binomial")
summary(ozonemodel2)
```

```{r airqual-log-model}
airqualmodel1 <- glm(data = dfc2, formula = ebiasiz15_airqual ~ con + rav_scored, family = "binomial")
summary(airqualmodel1)

airqualmodel2 <- glm(data = dfc2, formula = ebiasiz15_airqual ~ sc_scored + con + rav_scored, family = "binomial")
