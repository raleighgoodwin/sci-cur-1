...
df2[171:176] <- lapply(df2[171:176], as.numeric) # make numeric variables numeric
```
...
df3 <- df2 %>% 
  mutate(arctic20 = dplyr::recode(arctic2_1_sc, `1` = 3,
         ...
         icesheets20 = dplyr::recode(ice_sheets2_1_sc, `1` = 3,
                           ...
                           `6` = -2,
                           `7` = -3),
         icesheets20_s = scale(icesheets20),
...
```{r}
df3 <- df3 %>% # recode as indicated by Kahan et al 2017
